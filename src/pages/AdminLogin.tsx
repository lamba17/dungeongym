...
const ADMIN_EMAIL = "admin@dungeongym.com";
...
const AdminLogin = () => {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    if (email === ADMIN_EMAIL && password === ADMIN_PASSWORD) {
      sessionStorage.setItem("dungeon_admin", "true");
      ...
      >
        ...
        <div className="bg-card border border-border rounded-2xl p-8 red-border-glow">
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="admin@dungeongym.com"
                  required
                />
              </div>
            </div>
            ...
            <button
              type="submit"
              className="w-full btn-primary-premium py-3 text-sm"
            >
              Login
            </button>
          </form>
